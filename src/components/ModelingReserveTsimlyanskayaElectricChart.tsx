...
import { modelingReserveTsimlyanskayaElectricData } from "../data/modelingReserveTsimlyanskayaElectric";
...
export function ModelingReserveTsimlyanskayaElectricChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modelingreservetsimlyanskaya_electric', width, height);
  ...
  const allReserves = modelingReserveTsimlyanskayaElectricData.map(d => d.reserve);
  ...
  const allZero = modelingReserveTsimlyanskayaElectricData.every(d => d.reserve === 0);
  ...
  const data1 = [
    ...
    ...modelingReserveTsimlyanskayaElectricData.map((d) => {
