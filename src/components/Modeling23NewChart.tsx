...
import { modeling23NewData } from "../data/modeling23New";
...
export function Modeling23NewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modeling23_new', width, height);
  ...
  const allValues = [...modeling23NewData.map(d => d.total_net), ...modeling23NewData.map(d => d.load)];
