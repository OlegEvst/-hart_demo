...
import { reservePerovoData } from "../data/reservePerovo";
...
export function ReservePerovoChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/reserveperovo', width, height);
