...
import { modelingReserveKrasnoselskayaElectricData } from "../data/modelingReserveKrasnoselskayaElectric";
...
export function ModelingReserveKrasnoselskayaElectricChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modelingreservekrasnoselskaya_electric', width, height);
  ...
  const allReserves = modelingReserveKrasnoselskayaElectricData.map(d => d.reserve);
  ...
  const allZero = modelingReserveKrasnoselskayaElectricData.every(d => d.reserve === 0);
  ...
  const data1 = [
    ...
    ...modelingReserveKrasnoselskayaElectricData.map((d) => {
