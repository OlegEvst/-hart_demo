...
import { modeling11Data } from "../data/modeling11";
...
export function Modeling11Chart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modeling11', width, height);
