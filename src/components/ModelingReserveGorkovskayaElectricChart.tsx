...
import { modelingReserveGorkovskayaElectricData } from "../data/modelingReserveGorkovskayaElectric";
...
export function ModelingReserveGorkovskayaElectricChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modelingreservegorkovskaya_electric', width, height);
  ...
  const allReserves = modelingReserveGorkovskayaElectricData.map(d => d.reserve);
  ...
  const allZero = modelingReserveGorkovskayaElectricData.every(d => d.reserve === 0);
  ...
  const data1 = [
    ...
    ...modelingReserveGorkovskayaElectricData.map((d) => {
