...
import { modelingBalanceTsimlyanskayaElectricData } from "../data/modelingBalanceTsimlyanskayaElectric";
...
export function ModelingBalanceTsimlyanskayaElectricChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modelingbalancetsimlyanskaya_electric', width, height);
  ...
  const allValues = [...modelingBalanceTsimlyanskayaElectricData.map(d => d.total_net), ...modelingBalanceTsimlyanskayaElectricData.map(d => d.load)];
  ...
  const data1 = [
    ...
    ...modelingBalanceTsimlyanskayaElectricData.map((d) => {
