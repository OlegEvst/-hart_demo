...
import { reserveFrezNewData } from "../data/reserveFrezNew";
...
export function ReserveFrezNewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/reservefrez_new', width, height);
  ...
  const allReserves = reserveFrezNewData.map(d => d.reserve);
