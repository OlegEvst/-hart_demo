...
import { balance23NewData } from "../data/balance23New";
...
export function Balance23NewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/balance23_new', width, height);
  ...
  const allValues = [...balance23NewData.map(d => d.total_net), ...balance23NewData.map(d => d.load)];
