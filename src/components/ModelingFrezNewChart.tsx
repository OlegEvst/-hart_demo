...
import { modelingFrezNewData } from "../data/modelingFrezNew";
...
export function ModelingFrezNewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modelingfrez_new', width, height);
  ...
  const allValues = [...modelingFrezNewData.map(d => d.total_net), ...modelingFrezNewData.map(d => d.load)];
