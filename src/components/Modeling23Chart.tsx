...
import { modeling23Data } from "../data/modeling23";
...
export function Modeling23Chart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modeling23', width, height);
