...
import { balance11Data } from "../data/balance11";
...
export function Balance11Chart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/balance11', width, height);
  ...
  const data1 = [
    ...
    ...balance11Data.map((d) => [
      ...
      d.load,
      d.year === "2028" ? "" : Math.round(d.load).toString(),
      d.year === "2028" ? 911.4 : null,
      d.year === "2028" ? "911.4" : "",
    ]),
  ];
