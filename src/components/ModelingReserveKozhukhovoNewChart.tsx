...
import { modelingReserveKozhukhovoNewData } from "../data/modelingReserveKozhukhovoNew";
...
export function ModelingReserveKozhukhovoNewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modelingreservekozhukhovo_new', width, height);
  ...
  const allReserves = modelingReserveKozhukhovoNewData.map(d => d.reserve);
  ...
  const data1 = [
    ...
    ...modelingReserveKozhukhovoNewData.map((d) => [
      d.year,
      d.reserve,
