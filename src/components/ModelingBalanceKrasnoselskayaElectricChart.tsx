...
import { modelingBalanceKrasnoselskayaElectricData } from "../data/modelingBalanceKrasnoselskayaElectric";
...
export function ModelingBalanceKrasnoselskayaElectricChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modelingbalancekrasnoselskaya_electric', width, height);
  ...
  const allValues = [...modelingBalanceKrasnoselskayaElectricData.map(d => d.total_net), ...modelingBalanceKrasnoselskayaElectricData.map(d => d.load)];
  ...
  const data1 = [
    ...
    ...modelingBalanceKrasnoselskayaElectricData.map((d) => {
