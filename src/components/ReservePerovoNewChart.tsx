...
import { reservePerovoNewData } from "../data/reservePerovoNew";
...
export function ReservePerovoNewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/reserveperovo_new', width, height);
  ...
  const allReserves = reservePerovoNewData.map(d => d.reserve);
