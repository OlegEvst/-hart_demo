...
import { balance22NewData } from "../data/balance22New";
...
export function Balance22NewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/balance22_new', width, height);
  ...
  const allValues = [...balance22NewData.map(d => d.total_net), ...balance22NewData.map(d => d.load)];
