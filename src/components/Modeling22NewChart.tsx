...
import { modeling22NewData } from "../data/modeling22New";
...
export function Modeling22NewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modeling22_new', width, height);
  ...
  const allValues = [...modeling22NewData.map(d => d.total_net), ...modeling22NewData.map(d => d.load)];
