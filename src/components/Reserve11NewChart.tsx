...
import { reserve11NewData } from "../data/reserve11New";
...
export function Reserve11NewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/reserve11_new', width, height);
  ...
  const allReserves = reserve11NewData.map(d => d.reserve);
