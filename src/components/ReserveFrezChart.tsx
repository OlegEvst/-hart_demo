...
import { reserveFrezData } from "../data/reserveFrez";
...
export function ReserveFrezChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/reservefrez', width, height);
