...
import { modelingReserve11NewData } from "../data/modelingReserve11New";
...
export function ModelingReserve11NewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modelingreserve11_new', width, height);
  ...
  const allReserves = modelingReserve11NewData.map(d => d.reserve);
  ...
  const data1 = [
    ...
    ...modelingReserve11NewData.map((d) => [
      d.year,
      d.reserve,
