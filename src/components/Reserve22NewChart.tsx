...
import { reserve22NewData } from "../data/reserve22New";
...
export function Reserve22NewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/reserve22_new', width, height);
  ...
  const allReserves = reserve22NewData.map(d => d.reserve);
