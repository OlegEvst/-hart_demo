...
import { balancePerovoData } from "../data/balancePerovo";
...
export function BalancePerovoChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/balanceperovo', width, height);
