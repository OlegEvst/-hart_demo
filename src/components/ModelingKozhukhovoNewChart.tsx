...
import { modelingKozhukhovoNewData } from "../data/modelingKozhukhovoNew";
...
export function ModelingKozhukhovoNewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modelingkozhukhovo_new', width, height);
  ...
  const allValues = [...modelingKozhukhovoNewData.map(d => d.total_net), ...modelingKozhukhovoNewData.map(d => d.load)];
  ...
  const data1 = [
    ...
    ...modelingKozhukhovoNewData.map((d) => {
