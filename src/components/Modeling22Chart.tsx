...
import { modeling22Data } from "../data/modeling22";
...
export function Modeling22Chart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modeling22', width, height);
