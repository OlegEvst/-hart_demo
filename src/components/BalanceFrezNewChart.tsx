...
import { balanceFrezNewData } from "../data/balanceFrezNew";
...
export function BalanceFrezNewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/balancefrez_new', width, height);
  ...
  const allValues = [...balanceFrezNewData.map(d => d.total_net), ...balanceFrezNewData.map(d => d.load)];
