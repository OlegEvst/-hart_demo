...
import { modelingReserveFrezNewData } from "../data/modelingReserveFrezNew";
...
export function ModelingReserveFrezNewChart() {
  const [width, height] = useWindowSize();
  const savedConfig = useSavedChartConfig('/modelingreservefrez_new', width, height);
  ...
  const allReserves = modelingReserveFrezNewData.map(d => d.reserve);
  ...
  const data1 = [
    ...
    ...modelingReserveFrezNewData.map((d) => [
      d.year,
      d.reserve,
